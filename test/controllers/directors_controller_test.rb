...
class DirectorsControllerTest < ActionController::TestCase
  ...
  test "should create director" do
    assert_difference('Director.count') do
      post :create, director: { corporate_personnel_id: @director.corporate_personnel_id, full_legal_name: @director.full_legal_name, occupation: @director.occupation }
    end
  ...
  test "should update director" do
    patch :update, id: @director, director: { corporate_personnel_id: @director.corporate_personnel_id, full_legal_name: @director.full_legal_name, occupation: @director.occupation }
    assert_redirected_to director_path(assigns(:director))
  end
